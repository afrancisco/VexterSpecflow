...
namespace VexterSpecflow
{
    ...
    public class ValidarCompraOuVendaDeOrdemDeMercadoSteps
    {
        ...
        //[Then(@"Realizar compra ou venda")]
        //public void EntaoRealizarCompraOuVenda()
        //{
        //    Thread.Sleep(2000);
        //    driver.FindElement(By.Id("taSearch")).Clear();
        //    driver.FindElement(By.Id("taSearch")).Click();
        //    driver.FindElement(By.Id("taSearch")).SendKeys("WINZ18");
        //    //var listHits = driver.FindElements(By.CssSelector("button.mat-raised-button.button-type-symbool.type-one.mx-auto"));
        //    Thread.Sleep(3500);
        //    //listHits.First().Click();

        //    driver.FindElement(By.XPath("(.//*[normalize-space(text()) and normalize-space(.)='WINZ18'])[1]/following::button[1]")).Click();
        //    Thread.Sleep(2000);
        //    driver.FindElement(By.XPath("(.//*[normalize-space(text()) and normalize-space(.)='Validade:'])[1]/following::span[1]")).Click();
        //    Thread.Sleep(2000);
        //    driver.FindElement(By.XPath("(.//*[normalize-space(text()) and normalize-space(.)='compra de'])[1]/following::span[2]")).Click();
        //    Thread.Sleep(2000);
        //    driver.FindElement(By.XPath("(.//*[normalize-space(text()) and normalize-space(.)='ENVIAR ORDEM'])[1]/following::span[1]")).Click();
        //}
        //    if (driver.FindElement(By.XPath("//button/span")).Text.ToUpper().Equals("COMPRA"))
        //    {
        //        driver.FindElement(By.XPath("//button/span")).Click();
        //        Thread.Sleep(2000);
        //        driver.FindElement(By.XPath("//div[7]/button/span")).Click();
        //        Thread.Sleep(2000);
        //        driver.FindElement(By.XPath("(.//*[normalize-space(text()) and normalize-space(.)='CANCELAR'])[1]/following::span[1]")).Click();
        //        Thread.Sleep(3000);
        //        driver.FindElement(By.XPath("(.//*[normalize-space(text()) and normalize-space(.)='Ordem enviada com sucesso.'])[1]/following::button[1]")).Click();
        //    }
        //    Thread.Sleep(2000);
        //}
